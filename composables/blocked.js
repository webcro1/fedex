...
export async function checkIfBlocked() {
    ...
    if (error) return // Erreur de requête, on laisse passer

    if (data && data.is_blocked) {
        window.location.href = 'https://www.fedex.com/fr-fr/home.html'
        // On ne fait rien d'autre, la navigation s'arrête ici
    }
}
